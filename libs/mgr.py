...
pylib_paths = ["/lib/python2.7/site-packages/pltfm_mgr_rpc", "/lib/python2.7/site-packages/pltfm_pm_rpc", "/lib/python2.7/site-packages","/lib/python2.7/site-packages/thrift", "/lib/python2.7/site-packages/tofino_pd_api",
               "/lib/python3.5/site-packages", "/lib/python3.5/site-packages/p4testutils", "/lib/python3.5/site-packages/ptf", "/lib/python3.5/site-packages/tofino", "/lib/python3.5/site-packages/tofinopd",
               "/include"]
pylib_paths = [os.getenv('SDE_INSTALL')+p for p in pylib_paths]
pylib_paths.append("/root/sde-9.5.3-stratum/lib/python3.5/site-packages/tofino")
    ...
    if (self.p4Name != None):
      ...
      try:
        self.interface = gc.ClientInterface(grpc_addr, 
          ...
          notifications=None) 
        self.interface.bind_pipeline_config(self.p4Name)
        logging.debug("连接到 {}".format(grpc_addr))
